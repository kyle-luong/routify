            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-slate-300 px-4 py-2 transition-colors focus:border-sky-500 focus:ring-1 focus:ring-sky-500 focus:outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full resize-none rounded-lg border border-slate-300 px-4 py-2 transition-colors focus:border-sky-500 focus:ring-1 focus:ring-sky-500 focus:outline-none"
